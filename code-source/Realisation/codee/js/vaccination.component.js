class Vaccination extends React.Component {
    ...
    render() {
        ...
        let done = ''
        done += this.props.vaccination.date_vaccination < new Date() ? 'fait' :'pas-fait';

        return (
            <tr className={done}>
                
                <td className="align-middle"><i data-toggle="modal" data-target="#exampleModal1" className={add} onClick={this.props.onClickUpdate}></i></td>
