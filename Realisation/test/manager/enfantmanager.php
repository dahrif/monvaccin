...
class enfantManager {
	...
	public function getList(){
		...
		$stack = array();
		$req = 'SELECT * FROM enfant OUTER LEFT JOIN parent ON enfant.id_parent=parent.id_parent ORDER BY enfant.id_enfant ';
		...
		foreach ($result as $row){
			...
			$itm->setfirstname_parent($row["firstname_parent"]);
